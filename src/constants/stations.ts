export interface Station {
  ...
  lat: number;
  lng: number;
  sido?: string; // 서울 외 도시: 시도별 API 사용
}

/** 에어코리아 주요 측정소 좌표 (서울/경기/광역시) */
export const STATIONS: Station[] = [
  // 서울 (stationName으로 직접 조회)
  ...
  // 인천 구 단위 (stationName 직접 조회 가능)
  { name: "부평",     addr: "인천 부평구",   lat: 37.5074, lng: 126.7218 },
  { name: "남동",     addr: "인천 남동구",   lat: 37.4469, lng: 126.7314 },
  // 경기/인천/광역시 (sido 평균 API 사용)
  { name: "수원", addr: "경기 수원시", lat: 37.2636, lng: 127.0286, sido: "경기" },
  { name: "성남", addr: "경기 성남시", lat: 37.4201, lng: 127.1268, sido: "경기" },
  { name: "안양", addr: "경기 안양시", lat: 37.3943, lng: 126.9568, sido: "경기" },
  { name: "부천", addr: "경기 부천시", lat: 37.5034, lng: 126.766,  sido: "경기" },
  { name: "고양", addr: "경기 고양시", lat: 37.6584, lng: 126.832,  sido: "경기" },
  { name: "용인", addr: "경기 용인시", lat: 37.2411, lng: 127.1776, sido: "경기" },
  { name: "인천", addr: "인천시",      lat: 37.4563, lng: 126.7052, sido: "인천" },
  { name: "부산", addr: "부산시",      lat: 35.1796, lng: 129.0756, sido: "부산" },
  { name: "대구", addr: "대구시",      lat: 35.8714, lng: 128.6014, sido: "대구" },
  { name: "대전", addr: "대전시",      lat: 36.3504, lng: 127.3845, sido: "대전" },
  { name: "광주", addr: "광주시",      lat: 35.1595, lng: 126.8526, sido: "광주" },
  { name: "울산", addr: "울산시",      lat: 35.5384, lng: 129.3114, sido: "울산" },
];
