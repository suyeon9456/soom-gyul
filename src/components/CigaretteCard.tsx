...
export default function CigaretteCard({ locationName, cigarettes }: Props) {
  return (
    <div
      className="bg-slate-900 rounded-[2.5rem] p-6 text-white mb-8 shadow-2xl relative overflow-hidden
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h4 className="font-black text-sm text-rose-100 uppercase tracking-widest">
            유해성 비교 지표
          </h4>
        </div>
        <div className="space-y-2">
          <p className="text-lg leading-relaxed">
            오늘{" "}
            <span className="text-rose-400 font-black">{locationName}</span>에서
            숨 쉬는 것은
          </p>
          <p className="text-2xl font-black">
            담배{" "}
            <span className="text-rose-500 text-4xl mx-1">
              {cigarettes}개비
            </span>
            를 피우는 것과 같습니다.
          </p>
